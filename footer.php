...
<footer class="spacer">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h4>Hotel Biz</h4>
                    <p>To be the first choice for guests, colleagues, shareholders and business partners </p>
                    <p>And to delight our guests every time by creating engaging experiences straight from our heart.</p>
                </div>              
