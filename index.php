    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1  class="animated fadeInDown">Best hotel in Canada</h1>
                <p class="animated fadeInUp">Most luxurious hotel of north america with the royal treatments and excellent customer service.</p>                
            </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">Gallery<a href="gallery.php" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
